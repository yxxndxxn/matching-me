...
import { getLifestyleTags, getMajorCategoryLabel } from "@/lib/types"
          ...
          <div className="flex items-start justify-between gap-4 mb-4">
            <div className="min-w-0 space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground truncate">
                {profile.university} · {majorCategoryLabel}
              </p>
              <p className="text-xs text-muted-foreground truncate">
                {profile.grade} · {profile.dormitory}
              </p>
            </div>

            {/* Elegant Match Score Ring */}
