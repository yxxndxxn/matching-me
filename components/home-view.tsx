...
export function HomeView({
  ...
  const toggleSave = (profile: UserProfile) => {
    if (isProfileSaved(profile.id)) onUnsaveProfile?.(profile.id)
    else onSaveProfile?.(profile)
  }
  ...
  const handleRevealContact = (profile: UserProfile) => onRevealContact?.(profile)
